 ...
 */
public class BossIndicator extends LinearLayout {
    ...
    public BossIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 获得自定义属性
        ...
        Drawable drawable = a.getDrawable(R.styleable.BossIndicator_boss_indicator_src);
